...
import org.fossify.calendar.adapters.MyDayPagerTimepageAdapter
...
/**
 * Modern Day Fragments Holder with Timepage design
 * Manages ViewPager containing DayFragmentTimepage instances
 */
class DayFragmentsHolderTimepage : MyFragmentHolder(), NavigationListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        // Apply Timepage dark theme background
        binding.root.background = ColorDrawable(requireContext().getColor(R.color.dark_primary_background))
    ...
    private fun setupFragment() {
        ...
        val dailyAdapter = MyDayPagerTimepageAdapter(requireActivity().supportFragmentManager, codes, this)
    ...
    override fun refreshEvents() {
        (viewPager.adapter as? MyDayPagerTimepageAdapter)?.updateCalendars(viewPager.currentItem)
    }
    ...
    override fun printView() {
        (viewPager.adapter as? MyDayPagerTimepageAdapter)?.printCurrentView(viewPager.currentItem)
    }
