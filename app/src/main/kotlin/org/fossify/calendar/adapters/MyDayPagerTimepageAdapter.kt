...
import org.fossify.calendar.fragments.DayFragmentTimepage
import org.fossify.calendar.helpers.DAY_CODE
import org.fossify.calendar.interfaces.NavigationListener

/**
 * Modern Day Pager Adapter using Timepage design
 * Manages DayFragmentTimepage instances in a ViewPager for day navigation
 */
class MyDayPagerTimepageAdapter(
    fm: FragmentManager, 
    private val mCodes: List<String>, 
    private val mListener: NavigationListener
) : FragmentStatePagerAdapter(fm) {
    
    private val mFragments = SparseArray<DayFragmentTimepage>()
    ...
    override fun getItem(position: Int): Fragment {
        ...
        val fragment = DayFragmentTimepage()
